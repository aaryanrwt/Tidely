...
class TrustEngine:
    ...
    def __init__(self, strictness: str = "high"):
        ...
        self.threshold = {"conservative": 99.0, "high": 95.0, "moderate": 80.0}.get(strictness, 95.0)
        
    def evaluate(self, df: Any, metadata: Dict[str, Any], semantics: Dict[str, Any]) -> List[Dict[str, Any]]:
